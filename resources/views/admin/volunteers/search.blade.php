...
@section('content')
    ...
    <div class="container-fluid p-0">
        <div class="row d-flex justify-content-center">
            <div class="col-xxl-6 col-xl-5 col-lg-8 col-md-8">
                <form action="{{ route('volunteer.search-details') }}" method="POST">
                    ...
                    <div class="card p-1">
                        <div class="card-body">
                            <div class="row">
                                <div
                                    class="col-lg-9 col-md-9 col-12 mx-lg-0 ps-xl-0 ps-xl-0 ps-lg-0 ps-md-0 pe-lg-2 pe-md-2">
                                    <input type="search" placeholder="Search by name or regno" class="form-control"
                                        name="search_string">
                                </div>
                                <div
                                    class="col-lg-3 col-md-3 col-12 d-flex justify-content-center mt-lg-0 mt-lg-0 mt-2 mt-md-0 bg-danger">
