...
@section('content')
    ...
    <div class="container">
        <div class="row search-row" id="search" style="display: block;">
            <div class="col">
                <h3 class="text-center">Search Volunteer</h3>
                <div class="row">
                                                    ...
                                                    <div class="row details-row">
                                                        <div class="col-5 personal-info">
                                                            ...
                                                            <div class="row mb-2">
                                                                ...
                                                                <div class="col text-start details">{{ $v->name }}
                                                                </div>
                                                            </div>
                                                            <div class="row mb-2">
                                                                <div class="col-3 title">Reg.no</div>
                                                                <div class="col text-start details">{{ $v->id }}
                                                                </div>
                                                            </div>
                                                            <div class="row mb-2">
                                                                <div class="col-3 title">Email</div>
                                                                <div class="col text-start details">{{ $v->email }}
                                                                </div>
                                                            </div>
                                                            <div class="row mb-2">
                                                                <div class="col-3 title">Phone</div>
                                                                <div class="col text-start details">{{ $v->phone }}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col other-info">
                                                            ...
                                                            <div class="row mb-2">
                                                                ...
                                                                <div class="col text-start details">{{ $v->department }}
                                                                </div>
                                                            </div>
                                                            <div class="row mb-2">
                                                                <div class="col-5 title">Course</div>
                                                                <div class="col text-start details">{{ $v->course }}
                                                                </div>
                                                            </div>
                                                            <div class="row mb-2">
                                                                <div class="col-5 title">NSS Batch</div>
                                                                <div class="col text-start details">{{ $v->batch }}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col nss-info">
                                                            ...
                                                            <div class="row mb-2">
                                                                ...
                                                                <div class="col text-start details">{{ $v->absent }}
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                        ...
                                                                        <div class="row mb-3">
                                                                            <div class="col">
                                                                                <select name="batch" id=""
                                                                                    class="form-select">
                                                                                    <option value="2022-24" selected>
                                                                                        2022-24
                                                                                    </option>
                                                                                    <option value="2023-25">2023-25
                                                                                    </option>
                                                                                </select>
                                                                            </div>
                                                                            <div class="col"></div>
