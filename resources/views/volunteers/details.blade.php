        ...
        <div class="row details-row mt-5 p-0 d-flex justify-content-center">
            <div class="col bg- p-4 mx-4 border mb-4 bg-light">
                    ...
                    @foreach ($volunteer as $v)
                        ...
                        <div class="col nss-info">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col text-start details">{{ $v->drives_participated }}</div>
                            </div>
                ...
                <div class="row mt-4 mb-4">
                    <div class="col d-flex justify-content-center">
                        <button type="button" class="btn btn-success" data-target="#editInfoModal" data-toggle="modal"><i
                                class="bi-pencil-fill"></i> Edit details</button>
                    </div>
                </div>

                <!-- Start Edit/Update Details Section -->
                {{-- <div class="" id="editInfoModal"> --}}
                        ...
                        <div class="modal-content">
                            ...
                            <form action="">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col">
                                            <input type="text" name="regno" class="form-control" maxlength="9"
                                                pattern="[0-9]+" placeholder="Registration no*" value="{{ $v->id }}"
                                                disabled>
                                        </div>
                                        <div class="col">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col">
                                            <input type="number" name="phone" class="form-control"
                                                placeholder="Phone*" value="{{ $v->phone }}">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col">
                                            <select name="department" id="" class="form-select">
                                                <option value="{{ $v->department }}" selected>Department of Computer
                                                    Applications
                                                </option>
                                                <option value="">Department of Civil Enginieering</option>
                                                <option value="">Department of Computer Science Enginieering
                                                </option>
                                                <option value="">Department of Mechnical Engineering</option>
                                                <option value="">Department of Information Technology</option>
                                                <option value="">Department of Electrical and Electronics
                                                    Engineering
                                                </option>
                                                <option value="">Department of Electronics and Communication
                                                    Engineering
                                                </option>
                                                <option value="">Department of Artificial Intelligence and Data
                                                    Science
                                                </option>
                                        ...
                                        <div class="col">
                                            <select name="course" id="" class="form-select">
                                                <option value="" selected>{{ $v->course }}</option>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col">
                                            <select name="batch" id="" class="form-select">
                                                <option value="" selected>2022-24</option>
                                ...
                                <div class="modal-footer" style="background-color: #f1f1f1;">
                                    <div class="col">
                                        <span class="text-danger">Note: Contact System Administrator to change
                ...
                <div class="row">
                    <h5 class="text-center mt-3">Drives participated</h5>
                    <table class="table table-light table-striped">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td>Upper Majitar Cleanliness Drive</td>
                                <td>22-10-2023</td>
                            </tr>
                        </tbody>
                    </table>
